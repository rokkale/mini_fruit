...
class _CartBottomSheetState extends State<_CartBottomSheet> {
  ...
  void _showReceiptDialog(Order? order) {
    ...
    showDialog(
      ...
      builder: (ctx) => _ReceiptDialog(order: order),
    );
  }
...
// Sẵn sàng kết nối máy in bill: gọi ReceiptService().printReceipt(order).
// ─────────────────────────────────────────────────────────────────────────────
class _ReceiptDialog extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    // Thông tin đơn
                    _billInfoRow(
                        Icons.tag_rounded, 'Đơn hàng', '#${order.orderId ?? ""}'),
                    _billInfoRow(
                    ...
                    if (isTransfer) ...[
                      ...
                      const Center(
                        child: Text('QUÉT MÃ QR ĐỂ CHUYỂN KHOẢN',
                            style: TextStyle(
                                fontSize: 11,
                                fontWeight: FontWeight.bold,
                                letterSpacing: 0.8,
                      ...
                      // Ảnh QR từ VietQR — Image.network hoạt động trực tiếp trên web
                      Center(
                        child: ClipRRect(
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            _accountRow('Ngân hàng:', AppConstants.bankId),
                            _accountRow('Số TK:', AppConstants.bankAccount),
                            _accountRow('Chủ TK:', AppConstants.bankOwner),
                            _accountRow(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  // Nút in — kết nối máy in bill sau
                  Expanded(
  ...
  Widget _billInfoRow(IconData icon, String label, String value) => Padding(
  ...
  Widget _accountRow(String label, String value, {bool bold = false}) =>
      Padding(
        padding: const EdgeInsets.symmetric(vertical: 2),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
